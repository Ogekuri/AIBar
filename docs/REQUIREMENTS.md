...
- **TST-052**: MUST verify GNOME progress-bar layout clamps over-limit fill width, preserves the 100% marker, and keeps side-label widths constrained to prevent horizontal popup expansion.
