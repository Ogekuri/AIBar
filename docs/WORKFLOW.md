...
- `Internal Call-Trace Tree`
  - `main(...)`: CLI command router [`src/aibar/aibar/cli.py`]
    - `show(...)`: usage fetch/report route with idle-time cache gating and forced refresh override [`src/aibar/aibar/cli.py`]
      ...
      - `load_cli_cache(...)`: read persisted JSON cache payload (`~/.config/aibar/cache.json`) [`src/aibar/aibar/config.py`]
      - `load_idle_time(...)`: read persisted idle-time state (`~/.config/aibar/idle-time.json`) [`src/aibar/aibar/config.py`]
      ...
      - `save_cli_cache(...)`: persist refreshed payload to `~/.config/aibar/cache.json` [`src/aibar/aibar/config.py`]
